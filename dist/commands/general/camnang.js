...
exports.getCamNangEmbed = getCamNangEmbed;
exports.buildCamNangMenu = buildCamNangMenu;
...
const CAMNANG_DATA = {
    ...
    chuong3: {
        ...
        content: [
            ...
            '• Khi tu vi đạt đỉnh cảnh giới lớn, đạo hữu phải nghênh đón Lôi Kiếp để đột phá.',
...
class CamNangCommand extends Command_1.Command {
    constructor() {
...
function getCamNangEmbed(topic) {
...
function buildCamNangMenu(userId) {
...
async function handleCamNangSelect(interaction) {
