...
exports.getKhamBhaEmbed = getKhamBhaEmbed;
exports.getKhamBhaComponents = getKhamBhaComponents;
 ...
 */
function getKhamBhaEmbed(userId) {
 ...
 */
function getKhamBhaComponents(userId) {
    const user = UserRepository_1.userRepository.get(userId);
    const active = ExplorationService_1.explorationService.getActiveExploration(userId);
    const stamina = user?.stamina || 0;
...
class KhamBhaCommand extends Command_1.Command {
    constructor() {
...
exports.default = KhamBhaCommand;
