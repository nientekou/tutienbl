...
exports.dailyRotationService = void 0;
...
class DailyRotationService {
    ...
    getTodayRotation() {
        ...
        let rotation = database_1.default.prepare('SELECT * FROM daily_rotations WHERE date = ?').get(today);
        if (!rotation) {
...
exports.dailyRotationService = new DailyRotationService();
