...
exports.getEquippedSetCount = getEquippedSetCount;
exports.EQUIPMENT_SETS = [
    {
        id: 'set_hoa_than',
        name: 'Hỏa Thần',
        pieces: 2,
 ...
 */
function getEquippedSetCount(equippedItemIds, set) {
    return equippedItemIds.filter(itemId => set.item_ids.some(prefix => itemId.startsWith(prefix))).length;
}
