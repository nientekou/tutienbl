...
exports.getPhoiArmorByGrade = getPhoiArmorByGrade;
exports.getLegendaryWeapon = getLegendaryWeapon;
exports.isWeaponId = isWeaponId;
exports.isArmorId = isArmorId;
exports.isSeedId = isSeedId;
exports.isPhoiId = isPhoiId;
exports.ITEMS = {
    // ---- Đan dược (Pills) ----
...
function getArmorByGrade(grade) {
    return `armor_robe_${grade}`;
}
function getPhoiWeaponByGrade(grade) {
    return `phoi_weapon_${grade}`;
}
function getPhoiArmorByGrade(grade) {
    return `phoi_armor_${grade}`;
}
function getLegendaryWeapon(num) {
...
function isArmorId(itemId) {
    return itemId.startsWith('armor_');
}
function isSeedId(itemId) {
