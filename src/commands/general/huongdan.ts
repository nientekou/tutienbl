...
export default class HuongDanCommand extends Command {
  constructor() {
    super(
  ...
  public async execute(client: TuTienClient, interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    const menu = new ActionRowBuilder<StringSelectMenuBuilder>().addComponents(
      new StringSelectMenuBuilder()
        ...
        .addOptions(
          new StringSelectMenuOptionBuilder().setLabel('🌱 Bắt Đầu Tu Tiên').setValue('batdau').setDescription('Tạo nhân vật, các bước đầu tiên'),
          new StringSelectMenuOptionBuilder().setLabel('⛏️ Làm Việc & Kiếm Tài Nguyên').setValue('lamviec').setDescription('Công việc hàng ngày, thủ thuật'),
          new StringSelectMenuOptionBuilder().setLabel('⚔️ Chiến Đấu & PvP').setValue('chientran').setDescription('Săn quái, boss, bí cảnh, quyết đấu'),
          new StringSelectMenuOptionBuilder().setLabel('🛡️ Trang Bị & Cường Hóa').setValue('trangbi').setDescription('Trang bị, nâng sao, chế tạo, khí linh'),
          new StringSelectMenuOptionBuilder().setLabel('🪙 Kinh Tế & Tài Nguyên').setValue('taimat').setDescription('Tiền tệ, giao dịch, linh điền'),
          new StringSelectMenuOptionBuilder().setLabel('🌟 Nâng Cao & Đặc Biệt').setValue('nangcao').setDescription('Ý cảnh, luân hồi, tông môn, tọa kỵ'),
          new StringSelectMenuOptionBuilder().setLabel('☯️ Ngũ Hành Linh Căn').setValue('linhcan').setDescription('Tôi luyện, phân phẩm và thiên phú chiến đấu'),
          new StringSelectMenuOptionBuilder().setLabel('⚙️ Hệ Thống & Mẹo').setValue('vanhanh').setDescription('Lệnh tiện ích, mẹo hàng ngày'),
        )
    );
...
export function getHuongDanEmbed(topic: string): EmbedBuilder {
...
export function buildHuongDanMenu(userId: string): ActionRowBuilder<StringSelectMenuBuilder> {
...
export async function handleHuongDanSelect(interaction: StringSelectMenuInteraction): Promise<void> {
